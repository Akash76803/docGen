...
describe('Phase 7.3 layer UI regression',()=>{
 ...
 it('routes layer actions through stable multi-selection ordering',()=>{expect(designerSource).toContain('moveLayers(t,artboard.id,selectedSet.has(layer.id)?selection.elementIds:[layer.id]');});
