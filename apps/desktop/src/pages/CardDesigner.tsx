...
import { buildCardRenderModel, validateExportMemory, geometryToSvgPath, deletePathPointsSafely, splitPathSegment, insertPathNodeWithSymmetry, hitTestSegment, getPathEndpoints, getPathRangeBetweenNodes, deletePathSegmentRange, joinPathGeometries, closePathGeometry, worldToLocal, localToWorld, shapeToPathGeometry, getSmartTrimIntervals, findTrimInterval, trimSegmentInterval, erasePathWithWorldStroke, splitGeometryIntoConnectedFragments, normalizePathFragment, weldPathEndpointsToNearbyNodes, materializeStraightPathIntersections, findBoundarySnap, resolvePointSnap, splitComponentFaceByDivider, findJoinedLineRegionAtPoint, findCadRayIntersections, createCadLineGeometry, createCadLineMetadata, appendCadPolylinePoint, createCadPolylineMetadata, createCadXLineGeometry, createCadXLineMetadata, createCadRayGeometry, createCadRayMetadata, createCadArcGeometry, createCadArcMetadata, resolveCadDynamicEndpoint, type BoundarySnap, type PointSnapResult, type TrimInterval, type CardExportRequest } from '@document-tool/design-engine';
