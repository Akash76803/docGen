...
function ElementProperties({element,asset,assets,artboard,mutate,availableFields,datasourceStatus}:{element:DesignElement;asset?:AssetReference;assets:DesignTemplate['sharedAssets'];artboard:Artboard;mutate:(f:(t:DesignTemplate)=>DesignTemplate)=>void;availableFields:import('@document-tool/contracts').FieldDefinition[];datasourceStatus:string}){
 ...
 return <div className="card-property-sections">
  ...
  {element.type==='TEXT'&&<AdvancedTextProperties element={element} update={update} availableFields={availableFields} datasourceStatus={datasourceStatus}/>} {element.type==='SHAPE'&&<AdvancedShapeProperties element={element} update={update} assets={assets} mutate={mutate} artboardId={artboardId}/>} {element.type==='PATH'&&<AdvancedPathProperties element={element} update={update} assets={assets} mutate={mutate} artboardId={artboardId}/>} {element.type==='IMAGE'&&<AdvancedImageProperties element={element} update={update} availableFields={availableFields} datasourceStatus={datasourceStatus}/>} {element.type==='SVG'&&<SvgProperties element={element} asset={asset} update={update} availableFields={availableFields} datasourceStatus={datasourceStatus}/>} {element.type==='QR'&&<AdvancedQrProperties element={element as QrDesignElement} update={update} availableFields={availableFields} />} {element.type==='BARCODE'&&<AdvancedBarcodeProperties element={element as BarcodeDesignElement} update={update} availableFields={availableFields} />} 
...
function ShapeImageFillControls({element,assets,mutate,artboardId}:{element:ShapeDesignElement|PathDesignElement;assets:DesignTemplate['sharedAssets'];mutate:(f:(t:DesignTemplate)=>DesignTemplate)=>void;artboardId:string}){
...
function AdvancedShapeProperties({element,update,assets,mutate,artboardId}:{element:ShapeDesignElement;update:(f:(e:DesignElement)=>DesignElement)=>void;assets:DesignTemplate['sharedAssets'];mutate:(f:(t:DesignTemplate)=>DesignTemplate)=>void;artboardId:string}){
