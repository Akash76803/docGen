...
describe('Phase 8.6 rich artboard backgrounds', () => {
  ...
  it('keeps image crop transform and resolves dynamic image source', () => {
    ...
    const resolved = resolveArtboardBindings(value.artboards[0]!, { record:{ Photo:'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAB' } });
    ...
    expect((resolved.background as any).source).toBe('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAB');
  });
