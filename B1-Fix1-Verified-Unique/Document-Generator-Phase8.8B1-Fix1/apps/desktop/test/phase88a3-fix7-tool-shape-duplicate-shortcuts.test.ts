...
describe('Phase 8.8A3 Fix7 utility, shape and duplicate shortcuts', () => {
  ...
  it('registers direct utility tool shortcuts and Alt shape shortcuts', () => {
    ...
    expect(registry).toContain("shapeShortcut(['Alt', 'R'], 'Rectangle')");
    expect(registry).toContain("shapeShortcut(['Alt', 'C'], 'Circle')");
    expect(registry).toContain("shapeShortcut(['Alt', 'G'], 'Star')");
